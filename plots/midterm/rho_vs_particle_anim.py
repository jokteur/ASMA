...
from flowrect.simulations import particle_population, flow_rectification


# Plot saving parameters
save = False
save_path = ""
save_name = "rho-vs-pde.mp4"
...
t = time.time()
ts, a_grid, rho_t, m_t_exact, x_t, en_cons, A_t = flow_rectification(a_cutoff=5, **params)
...
class AnimatedPlot:
    ...
    def init_plot(self):
        ...
        self.ax1.legend(handles=[self.plots["rho"], self.plots["p_rho"]])
